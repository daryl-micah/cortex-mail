...
export default function AppShell() {
  ...
  return (
    <div className="h-screen flex flex-col md:grid md:grid-cols-[260px_1fr] lg:grid-cols-[260px_1fr_380px]">
      ...
      <div
        className={`absolute top-16 left-0 right-0 z-40 bg-background h-[calc(100vh-64px)] overflow-hidden md:relative md:top-auto md:h-full md:min-h-0 md:overflow-hidden ${assistantOpen ? 'block md:hidden' : 'hidden'} lg:block`}
      >
